...
- `RL-VLA³` 已找到官方代码仓库（https://github.com/Haoran0301/RL-VLA3），但仓库没有给出可下载的论文页或 arXiv 编号。
- `SAC-Flow` 虽被截图标为 ICLR 2026，但 ICLR 2026 官方主会论文列表中没有此题名；不能以相近论文替代。
- 其余缩写在公开索引中存在歧义；需要论文原链接、作者或完整正式标题才能安全补充。
