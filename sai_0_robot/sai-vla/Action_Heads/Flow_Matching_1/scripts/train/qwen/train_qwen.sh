...
# ============================================================================
# Flow Matching Action Head - Qwen 多层训练脚本
# ============================================================================
#
# 使用说明:
#   1. 修改下面的配置参数（数据集路径、GPU、训练参数等）
#   2. 运行: bash train_qwen_mulit_layers.sh
#
# 支持:
#   - 多GPU分布式训练 (使用 torchrun)
#   - Qwen2B/Qwen4B 多层 VLM hidden states
#   - 混合精度训练 (AMP)
#   - 梯度累积
#   - Wandb 日志记录
#
...
# 数据集路径 (必填)
# 需要包含多层 VLM hidden states，格式: (batch, num_layers, seq_len, hidden_dim)
DATA_PATH="/data/HuangWenlong/datasets/qwen_extract_three_layers_hidden_state/libero_github_convert_for_qwen2b-only-libero_spatial"
...
#       --input_path /data/.../libero_github_convert_for_qwen2b-only-libero_spatial \
...
#   /data/.../libero_github_convert_for_qwen2b-only-libero_spatial/webdataset_shard5000_ac25/
#   ├── shard-000000.tar
#   ├── shard-000001.tar
#   ├── ...
#   └── meta.json
...
WEBDATASET_SHARD_PATTERN="/data/HuangWenlong/datasets/qwen_extract_three_layers_hidden_state/libero_github_convert_for_qwen2b-only-libero_spatial/webdataset_shard5000_ac16/shard-{000000..000010}.tar"
...
echo "============================================================================"
echo "🚀 Flow Matching Action Head - Qwen 多层训练"
echo "============================================================================"
echo ""
echo "📁 路径配置:"
echo "  数据集: ${DATA_PATH}"
