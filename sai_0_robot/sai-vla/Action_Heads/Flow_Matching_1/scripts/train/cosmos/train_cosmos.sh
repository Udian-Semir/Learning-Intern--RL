...
# ============================================================================
# Flow Matching 1 Action Head - Cosmos Reason 2B VL (GR00T-N1.6-3B) 训练脚本
# ============================================================================
#
# 使用说明:
...
DATA_PATH="/data/HuangWenlong/datasets/libero_github_convert_for_Sai0-VLA_libero_10/libero_lerobot_10_sys0_cosmos/"
...
# VLM 输出维度
# Cosmos Reason 2B VL: 2048
VLM_OUTPUT_DIM=2048

# Action backbone 维度
# Cosmos Reason 2B VL: 1536
...
# Cosmos Reason 2B VL: 32 (2048 / 64 = 32)
...
WHICH_LAYER="-5" # 只在文件命名起作用，不影响实际训练
...
#       --input_path /data/.../libero_lerobot_10_sys0_cosmos \
...
#   /data/.../libero_lerobot_10_sys0_cosmos/webdataset_shard5000_ac25/
#   ├── shard-000000.tar
#   ├── shard-000001.tar
#   ├── ...
#   └── meta.json
...
WEBDATASET_SHARD_PATTERN="/data/HuangWenlong/datasets/libero_github_convert_for_Sai0-VLA_libero_10/libero_lerobot_10_sys0_cosmos/webdataset_shard5000_ac16/shard-{000000..000010}.tar"
...
echo "============================================================================"
echo "🌌 Flow Matching 1 Action Head - Cosmos Reason 2B VL (GR00T-N1.6-3B) 训练"
echo "============================================================================"
echo ""
echo "📁 路径配置:"
echo "  数据集: ${DATA_PATH}"
