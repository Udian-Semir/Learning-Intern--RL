...
class L1RegressionActionHead(nn.Module): # ! Used and Changed
    ...
    def predict_action(self, actions_hidden_states):
        ...
        # ! Changed here
        # rearranged_actions_hidden_states = actions_hidden_states.reshape(batch_size, 1, LLM_OUTPUT_DIM_MLP_INPUT_DIM)  
        rearranged_actions_hidden_states = actions_hidden_states.reshape(batch_size, 1, self.input_dim)  
