...
# ============================================================================
# OFT1_0 Action Head - Eagle 2.5 VL 训练脚本
# ============================================================================
#
# 使用说明:
...
DATA_PATH="/home/dev/文档/huangwenlong/dataset/libero_github_convert_for_Sai0-VLA_libero_10/libero_lerobot_10_sys0_eagle_-1/"
...
MODEL_NAME="eagle" # 只在文件命名起作用，不影响实际训练 # qwen3-2b, qwen3-4b, qwen3-8b, qwen3-32b, eagle2-5
...
#       --input_path /data/.../libero_lerobot_spatial_sys0_eagle_-1 \
...
#   /data/.../libero_lerobot_spatial_sys0_eagle_-1/webdataset_shard5000_ac25/
#   ├── shard-000000.tar
#   ├── shard-000001.tar
#   ├── ...
#   └── meta.json
...
WEBDATASET_SHARD_PATTERN="/home/dev/文档/huangwenlong/dataset/libero_github_convert_for_Sai0-VLA_libero_spatial/libero_lerobot_spatial_sys0_eagle_-1/webdataset_shard5000_ac16/shard-{000000..000010}.tar"
...
# State 维度 (设置为【处理后】的维度) # ! libero state 维度为 8，mydataset256 维度为 14
STATE_DIM=8
...
echo "============================================================================"
echo "🦅 OFT1_0 Action Head - Eagle 2.5 VL 训练"
echo "============================================================================"
echo ""
echo "📁 路径配置:"
echo "  数据集: ${DATA_PATH}"
