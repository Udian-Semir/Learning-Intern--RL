...
DATA_PATH="/data_disk1/hwl/unitree_train_v2_recipe_lerobot"
...
DATASET_NAME="unitree_v2_pretrain"
...
# ============================================================================
RESUME_FROM_CHECKPOINT="/data_disk2/hwl/checkpoints/unitree_v2_pretrain/action7_chunk16/p6000_bsz500*1*8_tb4_400000steps_layer14_20260511_wpunitree_v2_pretrain_unitree_v2_pretrain_CBC_true_dtypefloat32_USE_AMP_true_MD_true/checkpoints/step_300000"
...
# ============================================================================
USE_DIRECT_DISK_SHUFFLE="true" # ! 到400000steps 重新做shuffle，这个之前都是false
