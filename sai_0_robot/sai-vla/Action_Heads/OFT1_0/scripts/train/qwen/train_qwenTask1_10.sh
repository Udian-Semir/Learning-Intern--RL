...
DATA_PATH="/home/dev/文档/huangwenlong/vla-data-pipeline/lerobot_output/dataset111_single_512_filter_roi"
...
LR_SCHEDULER_TYPE="warmup_step_decay"
...
# ===== 保存配置 =====
GPU_NAME="p6000Task1_10"
# WHICH_LAYER="14_16_18" # 只在文件命名起作用，不影响实际训练（多层用下划线隔开）
WHICH_LAYER="1_18_36" # 只在文件命名起作用，不影响实际训练
MODEL_NAME="qwen4b" # 只在文件命名起作用，不影响实际训练 # qwen3-2b, qwen3-4b, qwen3-8b, qwen3-32b, eagle2-5
DATASET_NAME="dataset111_single_512_filter_roi"
...
# 二值化阈值 (平均值 > threshold -> 1, 否则 -> -1) # ! 2648/6=441.3333333333333
HAND_BINARY_THRESHOLD=550
...
# false: 使用原始 action
USE_ACTION_FROM_STATE_DIFF="true"
