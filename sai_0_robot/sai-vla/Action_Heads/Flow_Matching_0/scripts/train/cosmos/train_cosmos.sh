...
# ============================================================================
# Flow Matching 0 Action Head - Cosmos Reason 2B VL (GR00T-N1.6-3B) 训练脚本
# ============================================================================
#
# 使用说明:
...
DATA_PATH="/data/HuangWenlong/datasets/libero_github_convert_for_Sai0-VLA_libero_spatial/libero_lerobot_spatial_sys0_cosmos_-1"
...
WEBDATASET_SHARD_PATTERN="/data/HuangWenlong/datasets/libero_github_convert_for_Sai0-VLA_libero_spatial/libero_lerobot_spatial_sys0_cosmos_-1/webdataset_shard5000_ac16/shard-{000000..000010}.tar"
...
# 预训练权重文件路径 (留空则从头训练)
PRETRAINED_WEIGHTS="/home/sythoid_01/文档/Huangwenlong/sai0-vla/Action_Heads/Flow_Matching_0/pretrained_action_head.pt"
...
echo "============================================================================"
echo "🌌 Flow Matching 0 Action Head - Cosmos Reason 2B VL (GR00T-N1.6-3B) 训练"
echo "============================================================================"
echo ""
echo "📁 路径配置:"
echo "  数据集: ${DATA_PATH}"
...
if [ -n "${PRETRAINED_WEIGHTS}" ] && [ "${NO_PRETRAIN}" != "true" ]; then
    echo "🎯 预训练权重:"
