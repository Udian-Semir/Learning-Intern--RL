...
CHECKPOINT_PATH="/data/HuangWenlong/datasets/eagle_extract_-1_layer_hidden_state/libero_github_convert_for_eagle2-5-only-libero_spatial_sys0_weight/Flow_Matching_0/1layer_last/bsz16*8_20000steps/checkpoints/step_20000/action_head.pt"

# 数据集路径 (用于归一化统计量)
# 需要包含 meta/stats.json 文件
DATASET_PATH="/data/HuangWenlong/datasets/eagle_extract_-1_layer_hidden_state/libero_github_convert_for_eagle2-5-only-libero_spatial_sys0"
...
VLM_MODEL_PATH="/home/sythoid_01/.cache/huggingface/hub/models--nvidia--GR00T-N1.5-3B/snapshots/869830fc749c35f34771aa5209f923ac57e4564e"
