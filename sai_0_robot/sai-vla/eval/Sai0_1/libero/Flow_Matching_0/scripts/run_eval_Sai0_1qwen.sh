...
CHECKPOINT_PATH="/home/dev/文档/huangwenlong/dataset/libero_github_convert_for_Sai0-VLA_libero_goal/libero_lerobot_goal_sys1_qwen_2b_14_weight/FM0/1layer_14/p6000_bsz80*1*8_20000steps_16chunks_NO_PRETRAIN-true_layer14_20260122_wpflow_matching_0_eagle_libero_test_newest_libero_goal_USE_SHARED_CACHE_true_CACHE_VLM_STATES_false_USE_AMP_true_webdataset_false/checkpoints/step_20000/action_head.pt"

# 数据集路径 (用于归一化统计量)
# 需要包含 meta/stats.json 文件
DATASET_PATH="/home/dev/文档/huangwenlong/dataset/libero_github_convert_for_Sai0-VLA_libero_goal/libero_lerobot_goal_sys1_qwen_2b_14"
