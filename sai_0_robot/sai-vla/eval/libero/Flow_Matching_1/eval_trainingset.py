...
'''
python eval.py \
  --action-head-ckpt /data/HuangWenlong/datasets/Sai0_action_head_weight_libero/Qwen3-VL-8B-Instruct-hidden_dim_4096-vlm_layer_num_3-which_layer_0_17_35-total_layer_num_36/OFT1_0/experiments_20151202/libero_lerobot_object/checkpoints/best \
  --dataset-path /data/HuangWenlong/datasets/libero_github_convert_for_Sai0/libero_lerobot_object \
