#!/bin/bash
# ============================================================================
# OFT1_0 LIBERO 评估脚本 (非 Sai0 pipeline, Qwen)
# ============================================================================

# ===== 基本配置 =====
CHECKPOINT_PATH="/data/HuangWenlong/datasets/qwen_extract_three_layers_hidden_state/libero_github_convert_for_qwen2b-only-libero_spatial_weight/OFT1_0/3layer-1_14_28/bsz56*4_tb4/checkpoints/step_40000/action_head.pt"
...
# ===== 打印配置 =====
echo "============================================================================"
echo "🤖 OFT1_0 LIBERO 评估 (非 Sai0 pipeline, Qwen)"
echo "============================================================================"
echo ""
echo "📁 路径配置:"
