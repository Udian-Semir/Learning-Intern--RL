...
class Eagle2_5_VLForConditionalGeneration(Eagle2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def extract_feature(self, pixel_values):
        # ============================================================================
        # [MODIFIED] 处理 5 维 pixel_values 输入
        # 原始代码假设 pixel_values 是 4 维: (batch, channels, height, width)
        # 但 Eagle 2.5 VL 使用动态切片，pixel_values 可能是 5 维:
        #   (num_images, num_tiles, channels, height, width)
        # 需要先将其重塑为 4 维才能通过 vision_model
        # 修改时间: 2024-12
        # ============================================================================
