...
# ============================================================================
# [MODIFIED] VideoInput 导入兼容性修复
# 原始代码:
#     from transformers.image_utils import VideoInput
# 
# 修改原因: VideoInput 在 transformers < 4.45 版本中不存在
# 修改时间: 2024-12
# ============================================================================
try:
    from transformers.image_utils import VideoInput
...
class Eagle2_5_VLProcessor(ProcessorMixin):
        ...
        def replace_in_text(text):
            ...
            def repl(match):
                ...
                if media_type == "image":
                    ...
                    #     )
                    # 
                    # 修改原因: Eagle2ImageProcessor.preprocess() 不接受 videos 参数
                    # 修改时间: 2024-12
                    # ============================================================================
                    image_inputs = self.image_processor(
                        images=[image_list[idx_in_list]],
    ...
    def from_args_and_dict(cls, args, processor_dict: dict[str, Any], **kwargs):
        ...
        # ============================================================================
        # [MODIFIED] unused_kwargs 处理兼容性修复
        # 原始代码:
        #     kwargs.update(unused_kwargs)
        # 
        # 修改原因: validate_init_kwargs 在不同版本的 transformers 中返回类型不同
        #          - 某些版本返回 dict
        #          - 某些版本返回 list/tuple (包含字符串键或字典)
        #          直接调用 kwargs.update(unused_kwargs) 会导致:
